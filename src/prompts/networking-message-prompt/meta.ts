...
const meta: PromptMeta = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "networking message template for alumni",
    ],
  ...
  article: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Ninety words is roughly a phone screen without scrolling. It also removes the paragraph where people explain their background, which is the weakest part of any answer to how to message someone you have never met on LinkedIn.",
      ...
      },
      {
        ...
        body: [
          ...
          "A networking message template for alumni or a former colleague sits somewhere in between. A shared employer four years apart is a real but weak link, and weak links are exactly the ones that carry unfamiliar information, which is why they are worth using carefully rather than spending on a large ask straight away.",
        ],
      },
    ],
