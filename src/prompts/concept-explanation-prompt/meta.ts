...
6. WHAT I HAVE ASSUMED that you should verify before using this.`,
  ...
  eeat: {
    ...
    testingNote:
      "An analogy offered without limits gets taken literally, and electron shells stay planetary orbits in a learner's head until something much later contradicts it. Requiring the failure point in the sentence immediately after the comparison costs one line and heads off a misconception that takes a whole lesson to undo. Capping new terms at three keeps the explanation inside stated prior knowledge.",
  },
