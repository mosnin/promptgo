...
const meta: PromptMeta = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "plain language guide for public documents",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The better targets are the ones the prompt actually enforces. One idea per sentence. A named actor for every action. Obligation words left exactly as written. A gloss for anything a reader could not look up in a dictionary. A plain language guide for public documents usually amounts to these four rules with local variations.",
          "Obligation words deserve the strictest handling of all. Must, may, should and will encode whether something is required, permitted, recommended or promised, and a rewrite that swaps one for another has changed the reader's position without changing anything that looks important. That substitution is the single most common serious error in simplified official text.",
        ],
      },
    ],
