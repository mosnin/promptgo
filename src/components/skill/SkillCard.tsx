...
import type { SkillCardData } from "@/lib/skill-card";
...
/** A skill, presented as a specimen plate matching PromptCard/ToolCard, with a file count in place of an input count or opening line. */
export function SkillCard({ skill, accent = "var(--color-signal)", compact, index }: SkillCardProps) {
